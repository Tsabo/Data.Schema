...
public sealed class PostgresSchemaMigrator : ISchemaMigrator
{
    private readonly string _connectionString;
    private readonly IEnumerable<IMigrationHook> _hooks;

    public PostgresSchemaMigrator(string connectionString, IEnumerable<IMigrationHook>? hooks = null)
    {
        _connectionString = connectionString;
        _hooks = hooks ?? [];
    }

    public PostgresSchemaMigrator(NpgsqlConnection connection, IEnumerable<IMigrationHook>? hooks = null)
    {
